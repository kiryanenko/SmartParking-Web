...
[[ВВЕДЕНИЕ]{.underline} 8](#введение)

[[2]{.underline} [Анализ требований к СМПМ]](#анализ-требований-к-смпм)

[[2.1]{.underline} [Разработка диаграммы вариантов
использований]{.underline}
20](#разработка-диаграммы-вариантов-использований)

[[2.2]{.underline} [Описание и структура СМПМ]{.underline}
22](#_Toc515909590)

[[2.3]{.underline} [Описание функциональной схемы СМПМ]{.underline}
23](#описание-функциональной-схемы-смпм)

[[5]{.underline} [Разработка сервера]{.underline}
52](#разработка-сервера)

[[5.1]{.underline} [Анализ задания и выбор технологий]{.underline}
52](#анализ-задания-и-выбор-технологий)

[[5.2]{.underline} [Анализ способа хранения данных]{.underline}
54](#анализ-способа-хранения-данных)

[[5.3]{.underline} [Формы интерфейса]{.underline} 55](#формы-интерфейса)

[[5.4]{.underline} [Алгоритм выдачи парковочных мест]{.underline}
56](#алгоритм-выдачи-парковочных-мест)

[[5.5]{.underline} [Автоматизация развертывания серверного
ПО]{.underline} 60](#автоматизация-развертывания-серверного-по)

[[5.6]{.underline} [Балансировка нагрузки]{.underline}
62](#_Toc515909623)

[[7]{.underline} [Тестирование СМПМ]{.underline} 68](#тестирование-смпм)

[[ЗАКЛЮЧЕНИЕ]{.underline} 69](#заключение)

[[СПИСОК ИСПОЛЬЗОВАННЫХ ИСТОЧНИКОВ]{.underline}
...
для этих лиц показаны на рисунках Рисунок 5 и Рисунок 6.

Рисунок -- Диаграмма вариантов использований для пользователя

Рисунок -- Диаграмма вариантов использований для владельца стоянки
...
Рисунок -- Структурная схема системы мониторинга парковочных мест
...
Рисунок -- Функциональная схема СМПМ
...
(Рисунок 25). Поле «parking\_places\_count» добавлено с целью
...
В таблице «parking\_places» находятся парковочные места. Поля «booked»,
«free» и «connected» отвечают за текущее состояние ПМ. Поле «can\_book»
отвечает за возможность онлайн бронирования этого ПМ.

В таблице «parking\_states» хранится история изменения состояний
...
Поле «booked\_time» хранит время в секундах на сколько было
забронировано ПМ, а «end\_time» -- время окончания брони. При добавлении
...
На рисунке Рисунок 25 показана главная странице «/», на которой
...
На рисунке Рисунок 26 приводится схема алгоритма подключения нового
...
Рисунок -- Схема алгоритма подключения нового клиента к каналу
«MapChannel»
...
время нагрузочного тестирования (рисунки Рисунок 28, Рисунок 29). Как
...
макет, внешний вид которого изображен на рисунке Рисунок 30.
